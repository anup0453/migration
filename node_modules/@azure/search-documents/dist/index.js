...
exports.KnownLexicalTokenizerName = void 0;
...
})(exports.KnownLexicalTokenizerName || (exports.KnownLexicalTokenizerName = {}));
...
function generatedVectorSearchVectorizerToPublicVectorizer(generatedVectorizer) {
    ...
    switch (generatedVectorizer.kind) {
        ...
        case "customWebApi": {
            const { customWebApiParameters } = generatedVectorizer;
            const authIdentity = convertSearchIndexerDataIdentityToPublic(customWebApiParameters === null || customWebApiParameters === void 0 ? void 0 : customWebApiParameters.authIdentity);
...
function generatedSkillsetToPublicSkillset(generatedSkillset) {
    const { skills, cognitiveServicesAccount, knowledgeStore, encryptionKey, indexProjections } = generatedSkillset, props = tslib.__rest(generatedSkillset, ["skills", "cognitiveServicesAccount", "knowledgeStore", "encryptionKey", "indexProjections"]);
    return Object.assign(Object.assign({}, props), { skills: convertSkillsToPublic(skills), cognitiveServicesAccount: convertCognitiveServicesAccountToPublic(cognitiveServicesAccount), knowledgeStore: convertKnowledgeStoreToPublic(knowledgeStore), encryptionKey: convertEncryptionKeyToPublic(encryptionKey), indexProjections: indexProjections });
}
...
const BaseVectorSearchCompressionConfiguration = {
    type: {
        name: "Composite",
        className: "BaseVectorSearchCompressionConfiguration",
...
const CustomVectorizer = {
    ...
    type: {
        ...
        uberParent: "VectorSearchVectorizer",
        polymorphicDiscriminator: VectorSearchVectorizer.type.polymorphicDiscriminator,
        modelProperties: Object.assign(Object.assign({}, VectorSearchVectorizer.type.modelProperties), { customWebApiParameters: {
...
const ScalarQuantizationCompressionConfiguration = {
    ...
    type: {
        ...
        uberParent: "BaseVectorSearchCompressionConfiguration",
        polymorphicDiscriminator: BaseVectorSearchCompressionConfiguration.type.polymorphicDiscriminator,
        modelProperties: Object.assign(Object.assign({}, BaseVectorSearchCompressionConfiguration.type.modelProperties), { parameters: {
...
let discriminators = {
    ...
    BaseVectorSearchCompressionConfiguration: BaseVectorSearchCompressionConfiguration,
...
var Mappers = /*#__PURE__*/Object.freeze({
    ...
    ScalarQuantizationCompressionConfiguration: ScalarQuantizationCompressionConfiguration,
